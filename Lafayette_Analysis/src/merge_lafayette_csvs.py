...
def merge_lafayette_csvs():
    """
    Merge the three Lafayette PD CSV files into one, preserving all columns and data.
    """

    # Define the input files
    input_files = [
        'cprr_lafayette_pd_2009_2014.csv',
    ...
    output_file = 'cprr_lafayette_pd_2009_2025.csv'
